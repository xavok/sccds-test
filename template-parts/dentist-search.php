...
$d_args = array(
	...
	'meta_query' => array(
		array(
			'key' 		=> 'field_58c750f6680c2',  // bs_city
			'value'		=> $_location,
			'compare' 	=> '=',
		),
		array(
			'key' 		=> 'field_58c750fd680c3', // bs_state
			'value'		=> $_location,
			'compare' 	=> '=',
		),
		array(
			'key' 		=> 'field_58c75105680c4', // bs_zip
			'value'		=> $_location,
			'compare' 	=> '=',
		),
	)
...
if( $d_query->have_posts() ) : ?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class('blogpost-entry all-posts-wrapper dentist-search'); ?>>
