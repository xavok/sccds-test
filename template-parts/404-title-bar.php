	<?php
		...
		<header id="featured-hero" role="banner" style="background: url('<?php echo $image; ?>') no-repeat center bottom; background-size: cover;"><h1 class="entry-title">404 - Page Not Found</h1></header>
